  ...
  return (
    <div className="w-full min-h-full bg-white">
      <div className="container mx-auto px-4 py-6">
        {/* Header */}
        <header className="flex justify-between items-center mb-10 pl-10 pr-10">
          <div className="text-xl font-bold">Resume Builder</div>
          {user ? (
            <ProfileInfoCard />
          ) : (
            <button
              className="bg-purple-100 text-sm font-semibold text-black px-7 py-2.5 rouded-lg hover:bg-gray-800 hover:text-white transition-colors cursor-pointer"
        ...
        <section className="mt-5 pl-10 pr-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
              <h3 className="text-lg font-semibold mb-3">Beautifu Templates</h3>
              <p className="text-gray-600">
