...
const ThemeSelector = ({
  ...
  return (
    <div className="container mx-auto px-2 md:px-0">
      <div className="flex items-center justify-between mb-5 mt-2 mx-5">
      ...
      <div className="grid grid-cols-12 gap-5">
        <div className="col-span-12 md:col-span-5 bg-white">
          <div className="grid grid-cols-2 gap-5 max-h-[80vh] overflow-scroll custom-scrollbar md:pr-5 m-5">
            {tabValue === "Templates" &&
              resumeTemplate.map((template, index) => (
                <TemplateCard
